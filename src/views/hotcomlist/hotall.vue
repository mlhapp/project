...
export default {
  ...
  methods: {
    loadMore () {
      ...
      this.current++
      axios({
        url: `https://www.mei.com/appapi/clearance/clearanceCategoryProductList/v3?pageIndex=${this.current}&sort&key&brandNames&firstCategoryId&frontFirstCategoryIds&frontSecondCategoryIds&thirdCategories&productSizes&cmsId&size`
      }).then(res => {
